        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-4">
          ...
          <div>
            ...
            {config?.iosAppStoreUrl ? (
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-800 text-gray-400 dark:text-gray-500 text-sm rounded-lg cursor-default">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
